...
namespace BeatSaberPlus.Plugins.Chat
{
    /// <summary>
    /// Chat instance
    /// </summary>
    class Chat : PluginBase
    {
        ...
        /// Singleton
        /// </summary>
        internal static Chat Instance = null;
        ...
        /// <summary>
        /// Stream chat credits view
        /// </summary>
        private UI.SettingsLeft m_SettingsLeftView = null;
        /// <summary>
        /// Stream chat filters view
        /// </summary>
        ...
        /// <summary>
        /// Get settings filter view
        /// </summary>
        internal UI.SettingsRight SettingsRightView => m_SettingsRightView;
        ...
        protected override void OnEnable()
        {
            ...
            /// Bind events
            BeatSaberPlus.Utils.Game.OnSceneChange += OnSceneChange;

            /// If we are already in menu scene, activate
            if (BeatSaberPlus.Utils.Game.ActiveScene == BeatSaberPlus.Utils.Game.SceneType.Menu)
                OnSceneChange(BeatSaberPlus.Utils.Game.ActiveScene);

            if (!m_ChatCoreAcquired)
            {
                /// Init chat core
                m_ChatCoreAcquired = true;
                BeatSaberPlus.Utils.ChatService.Acquire();

                /// Run all services
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnLogin                 += ChatCoreMutiplixer_OnLogin;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnJoinChannel           += ChatCoreMutiplixer_OnJoinChannel;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnLeaveChannel          += ChatCoreMutiplixer_OnLeaveChannel;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnChannelFollow         += ChatCoreMutiplixer_OnChannelFollow;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnChannelBits           += ChatCoreMutiplixer_OnChannelBits;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnChannelPoints         += ChatCoreMutiplixer_OnChannelPoints;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnChannelSubscription   += ChatCoreMutiplixer_OnChannelSubscription;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnTextMessageReceived   += ChatCoreMutiplixer_OnTextMessageReceived;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnChatCleared           += ChatCoreMutiplixer_OnChatCleared;
                BeatSaberPlus.Utils.ChatService.Multiplexer.OnMessageCleared        += ChatCoreMutiplixer_OnMessageCleared;

                /// Get back channels
                foreach (var l_Channel in BeatSaberPlus.Utils.ChatService.Multiplexer.Channels)
        ...
        protected override void OnDisable()
        {
            ...
            if (m_ChatCoreAcquired)
            {
                ...
                BeatSaberPlus.Utils.ChatService.Release();
        ...
        private void OnSceneChange(BeatSaberPlus.Utils.Game.SceneType p_SceneType)
        {
        ...
        {
            if (BeatSaberPlus.Utils.Game.ActiveScene == BeatSaberPlus.Utils.Game.SceneType.Playing)
            {
        ...
        private void CreateFloatingWindow(BeatSaberPlus.Utils.Game.SceneType p_SceneType)
        {
            ...
            try
            {
                ...
                if (p_SceneType == BeatSaberPlus.Utils.Game.SceneType.Playing)
                {
                ...
                m_ChatFloatingScreenHandleMaterial       = GameObject.Instantiate(BeatSaberPlus.Utils.UnityMaterial.UINoGlowMaterial);
        ...
        internal void UpdateFloatingWindow(BeatSaberPlus.Utils.Game.SceneType p_SceneType, bool p_OnSceneChange)
        {
            if (m_RootGameObject == null)
                return;
