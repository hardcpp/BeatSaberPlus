...
namespace BeatSaberPlus.Plugins.SongChartVisualizer.Components
{
    /// <summary>
    ...
    internal class SongChart : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if ((l_DifficultyBeatmap != null && l_DifficultyBeatmap.beatmapData != null) || Utils.Game.ActiveScene == Utils.Game.SceneType.Menu)
            {
                ...
                if (l_SongDuration >= 0)
                {
                    ...
                    else if (Utils.Game.ActiveScene == Utils.Game.SceneType.Playing)
                    {
                    ...
                    m_CurrentGraphDataIndex = Utils.Game.ActiveScene == Utils.Game.SceneType.Menu ? (m_GraphData.Length / 2) : 0;
        ...
        public void BuildGraph()
        {
            ...
            if (Config.SongChartVisualizer.ShowNPSLegend)
            {
                ...
                for (var l_I = 0; l_I <= l_LabelCount; l_I++)
                {
                    ...
                    l_LegendLine.GetComponent<Image>().sprite                    = Utils.UnityTexture.LoadSpriteFromTexture(Texture2D.whiteTexture);
