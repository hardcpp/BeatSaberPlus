...
namespace BeatSaberPlus_ChatIntegrations.BeatSaber.Events
{
    ...
    /// Level resumed event
    /// </summary>
    public class LevelResumed : IEvent<LevelResumed, ChatPlexMod_ChatIntegrations.Models.Event>
    {
        ...
        public override sealed void BuildUI(Transform p_Parent)
        {
            ...
            {
                XUIVLayout.Make(
                    XUIText.Make("This event will be triggered whenever the map is resumed")
        ...
        protected override sealed bool CanBeExecuted(ChatPlexMod_ChatIntegrations.Models.EventContext p_Context)
        {
            ...
            if (p_Context.Type != ETriggerType.LevelResumed || p_Context.CustomData == null)
                return false;
