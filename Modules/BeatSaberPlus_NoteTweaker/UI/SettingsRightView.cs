    ...
    internal sealed class SettingsRightView : CP_SDK.UI.ViewController<SettingsRightView>
    {
        ...
        protected override void OnViewCreation()
        {
            Templates.FullRectLayout(
                Templates.TitleBar("Custom / Default"),
            ...
            m_Parent.transform.position = new Vector3(3.25f, 1.15f, 2.28f);
            m_Parent.transform.rotation = Quaternion.Euler(0.0f, 145.30f, 0.0f);
            ...
            UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(l_GameCoreSceneInfo.sceneName, UnityEngine.SceneManagement.LoadSceneMode.Additive).completed += (_) =>
            {
                UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(l_StandardGameplaySceneInfo.sceneName, UnityEngine.SceneManagement.LoadSceneMode.Additive).completed += (__) =>
                {
                    ...
                    var l_OriginalBombPrefab = l_BeatmapObjectsInstaller._bombNotePrefab;
                    ...
                    var l_OriginalBurstSliderPrefab = l_BeatmapObjectsInstaller._burstSliderNotePrefab;
        ...
        internal void RefreshSettings()
        {
            ...
            var l_ArrowLColor = l_Profile.ArrowsOverrideColors ? l_Profile.ArrowsLColor : ColorU.WithAlpha(l_LeftColor,  l_Profile.ArrowsLColor.a);
            var l_ArrowRColor = l_Profile.ArrowsOverrideColors ? l_Profile.ArrowsRColor : ColorU.WithAlpha(l_RightColor, l_Profile.ArrowsRColor.a);

            PatchArrow(m_CustomPreviewTL,  l_Profile.ArrowsScale,        ColorU.WithAlpha(l_ArrowLColor, l_Profile.ArrowsIntensity), true);
            PatchArrow(m_CustomPreviewTR,  l_Profile.ArrowsScale,        ColorU.WithAlpha(l_ArrowRColor, l_Profile.ArrowsIntensity), true);
            PatchArrow(m_CustomPreviewDL,  l_Profile.ArrowsScale,        ColorU.WithAlpha(l_ArrowLColor, l_Profile.ArrowsIntensity), false);
            PatchArrow(m_CustomPreviewDR,  l_Profile.ArrowsScale,        ColorU.WithAlpha(l_ArrowRColor, l_Profile.ArrowsIntensity), false);
        ...
        private void CreatePreview(GameObject p_NoteTemplate, GameObject p_BombTemplate, GameObject m_BurstFillTemplate)
        {
            ...
            PatchArrow(m_DefaultPreviewTL, 1f, ColorU.WithAlpha(l_LeftColor,  0.6f), true);
            PatchArrow(m_DefaultPreviewTR, 1f, ColorU.WithAlpha(l_RightColor, 0.6f), true);
        ...
        private void PatchNote(GameObject p_Object, Color p_Color)
        {
            ...
            if (l_Renderer != null && l_Renderer)
            {
                ...
                {
                    l_PropertyBlockController.materialPropertyBlock.SetColor(Shader.PropertyToID("_Color"),           ColorU.WithAlpha(p_Color, 1f));
