...
namespace ChatPlexMod_Chat.UI
{
    ...
    /// </summary>
    internal class HypeTrainFloatingWindow : BeatSaberPlus.SDK.UI.ResourceViewController<HypeTrainFloatingWindow>
    {
...
#pragma warning restore CS0649
        ...
        protected override sealed void OnViewCreation()
        {
            ...
            m_Filler.sprite     = CP_SDK.Unity.SpriteU.CreateFromTexture(Texture2D.whiteTexture);
            ...
            m_Filler.material   = BeatSaberPlus.SDK.Unity.MaterialU.UINoGlowMaterial;
