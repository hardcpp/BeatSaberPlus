...
namespace BeatSaberPlus_GameTweaker
{
    internal class GTConfig : CP_SDK.Config.JsonConfig<GTConfig>
    {
        ...
        internal class _MainMenu
        {
            ...
            [JsonProperty] internal Color   BaseColor                       = new Color(0.421376616f, 0.201642916f, 0.67450980f, 1f);
            [JsonProperty] internal Color   LevelClearedColor               = new Color(0.203647852f, 0.479708000f, 0.07326582f, 1f);
            [JsonProperty] internal Color   LevelFailedColor                = new Color(0.796078444f, 0.137425855f, 0.00000000f, 1f);
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)] internal _Environment      Environment     = new _Environment();
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)] internal _LevelSelection   LevelSelection  = new _LevelSelection();
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)] internal _PlayerOptions    PlayerOptions   = new _PlayerOptions();
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)] internal _MainMenu         MainMenu        = new _MainMenu();
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)] internal _Tools            Tools           = new _Tools();
