...
namespace BeatSaberPlus.SDK.UI
{
    ...
    public static class HMUITextSegmentedControl
    {
        ...
        {
            HMUI.TextSegmentedControl l_Prefab = Resources.FindObjectsOfTypeAll<HMUI.TextSegmentedControl>().First(x => x.name == "BeatmapDifficultySegmentedControl" && x._container != null);
