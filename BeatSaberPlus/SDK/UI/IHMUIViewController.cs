...
namespace BeatSaberPlus.SDK.UI
{
    ...
    /// </summary>
    public abstract class IHMUIViewController : HMUI.ViewController
    {
        ...
        public abstract void ShowModal(CP_SDK.UI.IModal p_Modal);
        /// <summary>
        /// Close a modal
        /// </summary>
        /// <param name="p_Modal">Modal to close</param>
        public abstract void CloseModal(CP_SDK.UI.IModal p_Modal);
        /// <summary>
        /// Close all modals
        /// </summary>
