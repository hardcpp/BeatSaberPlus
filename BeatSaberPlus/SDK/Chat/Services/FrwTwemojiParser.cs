...
namespace BeatSaberPlus.SDK.Chat.Services
{
    public class FrwTwemojiParser : IEmojiParser
    {
        ...
        public void FindEmojis(string p_Str, List<IChatEmote> p_Emotes)
        {
            ...
            foreach(Match l_Match in s_EmojiRegex.Matches(p_Str))
            {
                ...
                var l_Emoji = new Emoji()
                {
                    ...
                    Uri         = $"https://raw.githubusercontent.com/twitter/twemoji/8c1357b6a1400cd8fcf72596aa52da1f1daee634/assets/72x72/{l_UnicodeStr.ToLower()}.png",
