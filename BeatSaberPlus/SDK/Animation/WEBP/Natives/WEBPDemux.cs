...
namespace BeatSaberPlus.SDK.Animation.Natives
{
    public class WEBPDemux
    {
        ...
        public static IntPtr WebPAnimDecoderNew(byte[] webp_data)
        {
            ...
            {
                Logger.Instance.Error("[SDK.Animation.WEBP.Natives][WEBPDemux.WebPAnimDecoderNew] Error:");
        ...
        public static bool WebPAnimDecoderGetNext(IntPtr dec, byte[] outputbuffer, ref int timestamp)
        {
            ...
            {
                Logger.Instance.Error("[SDK.Animation.WEBP.Natives][WEBPDemux.WebPAnimDecoderGetNext] Error:");
                Logger.Instance.Error(l_Exception);
            }
