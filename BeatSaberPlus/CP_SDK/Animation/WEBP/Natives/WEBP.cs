...
namespace CP_SDK.Animation.WEBP.Natives
{
    public class WEBP
    {
        ...
        public static VP8StatusCode WebPGetFeatures(byte[] rawWebP, ref WebPBitstreamFeatures features)
        {
            ...
            {
                ChatPlexSDK.Logger.Error("[CP_SDK.Animation.WEBP.Natives][WEBP.WebPGetFeatures] Error:");
        ...
        public static int WebPDecodeBGRInto(byte[] data, IntPtr output_buffer, int output_buffer_size, int output_stride)
        {
            ...
            {
                ChatPlexSDK.Logger.Error("[CP_SDK.Animation.WEBP.Natives][WEBP.WebPDecodeBGRInto] Error:");
                ChatPlexSDK.Logger.Error(l_Exception);
            }
            finally
            {
