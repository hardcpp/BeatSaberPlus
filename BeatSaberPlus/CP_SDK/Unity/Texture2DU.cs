...
namespace CP_SDK.Unity
{
    ...
    public class Texture2DU
    {
        ...
        /// <returns></returns>
        public static Texture2D ResampleAndCrop(Texture2D p_Source, int p_TargetWidth, int p_TargetHeight, float p_YOffsetRel = 0.5f)
        {
        ...
        /// <returns></returns>
        public static Texture2D Blur(Texture2D p_Image, int p_BlurSize)
        {
            Texture2D l_Blurred = new Texture2D(p_Image.width, p_Image.height);
