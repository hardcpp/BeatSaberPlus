if (g_ServicesCount == 1 && document.getElementById('twitch_tokenchat').value == "") {
...
if (g_ServicesCount == 1 && l_TwitchChannel1.value == "" && l_TwitchChannel2.value == "" && l_TwitchChannel3.value == "" && l_TwitchChannel4.value == "" && l_TwitchChannel5.value == "") {
