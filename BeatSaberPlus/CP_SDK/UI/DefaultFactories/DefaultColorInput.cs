...
{
    /// <summary>
    /// Default CColorInput factory
    /// </summary>
    public class DefaultColorInput : FactoryInterfaces.IColorInput
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Components.CColorInput Create(string p_Name, Transform p_Parent)
        {
            ...
            var l_Element = l_GameObject.AddComponent<DefaultComponents.DefaultCColorInput>();
            l_Element.Init();
