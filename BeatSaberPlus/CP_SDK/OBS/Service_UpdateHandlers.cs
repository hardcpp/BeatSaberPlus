    ...
    public partial class Service
    {
        ...
        private static void Update_SceneItemVisibilityChanged(JObject l_JObject)
        {
            ...
            if (m_Scenes.TryGetValue(l_SceneName, out var l_Scene))
            {
                ...
                {
                    ChatPlexSDK.Logger.Error("[CP_SDK.OBS][Service.Update_SceneItemVisibilityChanged] Source \"" + (l_SourceName != null ? l_SourceName : "<unk>") + "\" is missing, refreshing all scenes");
                    RefreshSceneList();
                }
            }
            else
            {
                ChatPlexSDK.Logger.Error("[CP_SDK.OBS][Service.Update_SceneItemVisibilityChanged] Scene \"" + (l_SceneName != null ? l_SceneName : "<unk>") + "\" is missing, refreshing all scenes");
                RefreshSceneList();
            }
        }
