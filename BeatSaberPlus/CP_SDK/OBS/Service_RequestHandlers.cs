    ...
    public partial class Service
    {
        ...
        private static void Handle_GetAuthRequired(JObject p_JObject)
        {
            ...
            if (l_IsAuthRequired)
            {
                ...
                var l_Secret        = System.Convert.ToBase64String(Cryptography.SHA256.GetHash(OBSModSettings.Instance.Password + l_Salt));
        ...
        private static void Handle_GetSceneList(JObject p_JObject)
        {
            ...
            try
            {
                ...
                for (int l_I = 0; l_I < l_CurrentSceneList.Length; ++l_I)
                {
                    ...
                    {
                        ChatPlexSDK.Logger.Debug("[CP_SDK.OBS][Service.Handle_GetSceneList] Scene \"" + l_SceneToRemove.name + "\" was destroyed!");
            ...
            {
                ChatPlexSDK.Logger.Error("[CP_SDK.OBS][Service.Handle_GetSceneList] Error:");
