using BSP_ICSharpCode.SharpZipLib.Checksum;
using BSP_ICSharpCode.SharpZipLib.Core;
using BSP_ICSharpCode.SharpZipLib.Encryption;
using BSP_ICSharpCode.SharpZipLib.Zip.Compression;
using BSP_ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using System;
...
namespace BSP_ICSharpCode.SharpZipLib.Zip
{
	/// <summary>
	...
	public class ZipOutputStream : DeflaterOutputStream
	{
		...
		/// </exception>
		/// <see cref="BSP_ICSharpCode.SharpZipLib.Zip.Compression.Deflater"/>
